...
for (const code of ["PRODUCT_MISMATCH", "WRONG_LOGO", "SCREENSHOT_MISCHARACTERIZED", "INVENTED_COMMERCIAL_FACT", "WRONG_PRICE", "CRITICAL_OVERLAP", "COMPOSITION_BROKEN", "WRONG_ASPECT_RATIO", "REQUIRED_ASSET_MISSING", "NON_PUBLISHABLE_SOURCE"]) {

...
export function TenantSwitcher() {
  ...
  return (
    <select
      ...
      className="max-w-full rounded-lg border border-border bg-surface px-2.5 py-1.5 text-xs font-medium text-ink outline-none focus:border-primary sm:max-w-xs"
    >

...
import { connectInboxRabbitMq, INBOX_REALTIME_EXCHANGE } from "./inbox-rabbitmq-topology.js";

/**
 * Ponte entre o RabbitMQ e os clientes SSE conectados a ESTA instância de `zuno-api` — módulo
 * Conversas, Fase 3. Liga uma fila exclusiva/auto-delete à exchange fanout `inbox.realtime` (única
 * por instância — nunca compartilhada entre processos, nunca durável) e republica cada
